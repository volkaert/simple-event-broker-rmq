...
import fr.volkaert.event_broker.operation_manager.BrokerConfig;
...
public class OperationManagerReadinessHealthIndicator implements CompositeHealthContributor {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OperationManagerReadinessHealthIndicator.class);

    private Map<String, HealthContributor> contributors = new LinkedHashMap<>();

    public OperationManagerReadinessHealthIndicator() {
